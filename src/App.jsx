...
return (<>
  {!mensajeFelicidades?<div className="flex flex-col items-center bg-gray-100 overflow-hidden">
      ...
      :<div className='flex flex-col items-center'>
          ...
          <p className='px-5 text-xs md:text-4xl'>Sus datos han sido enviados con exito!!</p>
        </div>}
    </>)
}
